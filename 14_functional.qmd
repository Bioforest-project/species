...
Next we could investigate trait data available for more than 50% of species, which were not many.

> We could go to less represented traits in the future, and some trait might be redundant and results in the low observed values.
...
Using TALLO [@jucker2022], we retrieved tree diameter and height measurements for 495 species from our dataset:
