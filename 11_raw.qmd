...
First we explored raw species data content. This corresponds to **version 3**.
...
-   Scientific only - taxonomic information only in scientific name: Ecosilva, Jenaro Herrera, Kibale, Lesong, Mbaiki, Misiones, Nelliyampathy, STREK, Sungai Lalang, Ulu Muda
...
write_tsv(taxo, "data/derived_data/raw_taxo_preped_v3.tsv")
```

## All

We had data for 25 sites:
...
In total, we thus add 2,163 species before cleaning:
